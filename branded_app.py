...
# Optional logo/banner placeholder
# Uncomment and add your logo file to the repo
# st.image("logo.png", width=200)

st.markdown("# 💓 Heart Rate Analysis Dashboard")
st.markdown("### Built with ❤️ by **Shreya Shukla** | AI-Powered Insight into Your Heartbeat")
st.markdown("---")
...
# -------------------------
st.markdown("---")
st.markdown("<center><sub>© 2025 Shreya Shukla | Powered by Streamlit</sub></center>", unsafe_allow_html=True)
